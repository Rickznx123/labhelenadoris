...
export const metadata: Metadata = {
  title: "Convênios",
  description: "Atendimento particular e convênio Ampla+.",
};

export default function ConveniosPage() {
  return (
    <Container className="space-y-8 py-16">
      <h1 className="font-display text-5xl">Convênios</h1>
      <p className="text-muted-foreground">Atendimento particular e convênio Ampla+.</p>
      <Card className="max-w-2xl">
        <CardHeader>
          <CardTitle>Convênio atendido</CardTitle>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-[140px_1fr] md:items-center">
          ...
          <p className="text-muted-foreground">Nossa equipe está pronta para orientar sobre cobertura, preparo e prazos de entrega dos exames.</p>
        </CardContent>
      </Card>
    </Container>
  );
